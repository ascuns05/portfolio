...
function my_theme_load_resources() {
	...
	wp_enqueue_style( 'meda', get_template_directory_uri() . '/css/media.css', array(), '0.1' );	
	...
	wp_enqueue_script( 'lazyloadjs', get_template_directory_uri() . '/libs/lazyload/jquery.lazyload.min.js', array(), '0.1', true );
